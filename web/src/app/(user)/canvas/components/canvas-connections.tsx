...
export function buildConnectionPathD(from: Pick<CanvasNodeData, "position" | "width" | "height">, to: Pick<CanvasNodeData, "position" | "width" | "height">) {
...
export const ConnectionPath = memo(function ConnectionPath({
    ...
    return (
        <g data-connection-id={connection.id} data-from={from.id} data-to={to.id}>
            <path
