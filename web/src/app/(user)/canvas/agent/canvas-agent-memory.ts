...
export const MAX_RECENT_PROTOCOL_TOKENS = 64_000;
export const MAX_COMPACTED_CONTEXT_TOKENS = 16_000;
...
export function estimateCanvasAgentProtocolTokens(messages: CanvasAgentProtocolMessage[]) {
...
export function groupProtocolMessages(messages: CanvasAgentProtocolMessage[]) {
