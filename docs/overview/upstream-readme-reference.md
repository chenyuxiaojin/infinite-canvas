...
<h1 align="center">小陈的画布</h1>

基于 [infinite-canvas](https://github.com/tigerowo/infinite-canvas) 的本地优先个人分支，从 **v1.0.0** 独立维护。macOS 本机使用见 [桌面说明](desktop/README.md)。保留上游 MIT 许可与原作者声明；下方上游下载及服务链接不代表本分支的发行包或更新源。
...
<p align="center">
  <strong>上游项目的 Windows 安装包（非本分支）</strong><br>
